...
if response.status_code == 200:
    ...
    # Obtener el timestamp actual en formato datetime
    current_timestamp = datetime.now()

    # Convertir el valor a una cadena de texto con el formato adecuado
    current_timestamp_str = current_timestamp.strftime('%Y-%m-%d %H:%M:%S')

    # Definir 'timestamp' con el valor actual del timestamp en formato de texto
